...
e-commerce websites in particular, which traditionally utilize
collaborative filtering for their methods. This package includes several
interesting features, particularly a use of the latent factor model in
predictions. 
